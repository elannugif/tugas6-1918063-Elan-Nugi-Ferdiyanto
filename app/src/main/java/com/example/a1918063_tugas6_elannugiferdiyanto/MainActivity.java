package com.example.a1918063_tugas6_elannugiferdiyanto;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void startOneTimeTask(){
        ...
        Data data = new Data.Builder()
                .putString(weatherworkmanagar.EXTRA_CITY,spCity.getSelectedItem().toString())
                .build();
        ...
        OneTimeWorkRequest oneTimeWorkRequest = new OneTimeWorkRequest.Builder(weatherworkmanagar.class)
                .setInputData(data)
    ...
    private void startPeriodicTask(){
        ...
        periodicWorkRequest = new PeriodicWorkRequest.Builder(weatherworkmanagar.class, 15, TimeUnit.MINUTES)
                .setInputData(data)
                .setConstraints(constraints)
                .build();
