...
public class weatherworkmanagar extends Worker {
    ...
    private static final String TAG = weatherworkmanagar.class.getSimpleName();
    private Result resultStatus;
    public weatherworkmanagar(@NonNull Context context, @NonNull WorkerParameters workerParams) {
